...
int main()
{
    ...
    do
    {
        ...
        case 2:
            ...
            A.get();
            int l;
            cout << "--> 1 for entering the Toll_tax plaza" << endl;
            cout << "--> Any other numeric value to denote avoiding of Toll_tax." << endl;
            cout << "enter your choice : " << endl;
            cin >> l;
            do
            {
            ...
            cout << "This vehicle(@ present) follows an alternative road. \n";
            cout << "The no of vehicles crossed the Toll_tax at present : \n"
                 << A.count << endl;
            break;
